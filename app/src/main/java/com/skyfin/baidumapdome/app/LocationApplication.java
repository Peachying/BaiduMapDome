package com.skyfin.baidumapdome.app;
...
public class LocationApplication extends Application {
    ...
    public  OnStringBuffer myOnGetStringBuffer;
    @Override
    ...
    public class MyLocationListener implements BDLocationListener {
        ...
        public void onReceiveLocation(BDLocation location) {
            ...
            Log.d("skyfin", location.getLatitude() + "     " + location.getLongitude());
            ...
            if (list != null) {
                pMyLocation.setList(list);
            }
            myOnGetStringBuffer.buffer(pMyLocation);
        }
    }


    public static interface OnStringBuffer{
        void buffer(MyLocation myLocation);
    }
    public void setStringBuffer(OnStringBuffer onStringBuffer){
        this.myOnGetStringBuffer = onStringBuffer;
    }
}
